import {
  ...
  IconVideo, IconGlobe, IconPencil, IconFolder
} from '../components/icons';

export const categories = [
  { id: 'noticias',      title: 'Notícias',             icon: <IconNewspaper size={28} />,  color: 'dark-blue' },
  ...
  { id: 'outros',        title: 'Outras Produções',     icon: <IconFolder size={28} />,     color: 'blue' },
];