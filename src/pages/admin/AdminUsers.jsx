...
import { getAllUsers, approveUser, rejectUser, blockUser, deleteUser } from '../../services/adminService';
import { useToast } from '../../context/ToastContext';
import { IconSearch, IconCheck, IconClose, IconEye, IconTrash } from '../../components/icons';
                          ...
                          {expandedId === user.id && (
                              <div className="mobile-expanded-content">
                                ...
                                <div className="admin-table-actions" style={{ marginTop: 12 }}>
                                  ...
                                  <button className="action-btn btn-delete" onClick={() => handleDeleteUser(user.id, user.name)}><IconTrash size={14}/> <span className="action-text">Excluir</span></button>
                                </div>
                              </div>
                          )}
                        </td>
